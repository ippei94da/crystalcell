...
class TC_Povray_Cell < Test::Unit::TestCase
  ...
  def test_lattice_to_povs
    corrects = [
      "object { cylinder{ < 0.0000,  0.0000,  0.0000>, < 0.0000,  0.0000,  2.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 0.0000,  2.0000,  0.0000>, < 0.0000,  2.0000,  2.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 2.0000,  0.0000,  0.0000>, < 2.0000,  0.0000,  2.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 2.0000,  2.0000,  0.0000>, < 2.0000,  2.0000,  2.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 0.0000,  0.0000,  0.0000>, < 0.0000,  2.0000,  0.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 2.0000,  0.0000,  0.0000>, < 2.0000,  2.0000,  0.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 0.0000,  0.0000,  2.0000>, < 0.0000,  2.0000,  2.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 2.0000,  0.0000,  2.0000>, < 2.0000,  2.0000,  2.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 0.0000,  0.0000,  0.0000>, < 2.0000,  0.0000,  0.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 0.0000,  0.0000,  2.0000>, < 2.0000,  0.0000,  2.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 0.0000,  2.0000,  0.0000>, < 2.0000,  2.0000,  0.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n",
      "object { cylinder{ < 0.0000,  2.0000,  2.0000>, < 2.0000,  2.0000,  2.0000>,  0.0100 } pigment { color rgb <0.50, 0.50, 0.50> } }\n" ,
    ]
